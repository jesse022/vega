...
@Slf4j
@Component
public class VegaEntryGodownFinishedListener {
    ...
    @Subscribe
    public void onFinished(VegaEntryGodownFinishedEvent event) {
        List<ShopOrder> orders = event.getAlreadyEntryOrders();
